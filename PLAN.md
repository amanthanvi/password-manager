...
Status: Shipped `v0.1.0` (tag `v0.1.0` -> `d58cde2`)
...
- [x] Release artifacts published: GitHub Release `v0.1.0` includes desktop packages, CLI archives, `SHA256SUMS.txt`, and SBOM uploads.
...
- [x] Release: add packaging/signing workflow scaffolds and checksum publication for GitHub releases (SPEC P1–P4).
